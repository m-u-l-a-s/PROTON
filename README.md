...
- **Requisito Funcional 04:** Personalização de Etapas
- **Requisito Funcional 05:** Atribuição de Prioridade
- **Requisito funcional 06:** Personalização de Fluxo de Trabalho
...
Este requisito se trata da personalização visual das etapas.

### Requisito Funcional 05: Atribuição de Prioridade

Este requisito se trata de atribuir uma prioridade a etapa no momento de criação desta, como alta, média e baixa. Junto a personalização das etapas, a partir daqui as etapas declaradas como de alta prioridade ocupação os espaços iniciais dos cards da lista de etapas, depois as de média prioridade e por fim as de baixa prioridade.

### Requisito Funcional 06: Personalização de Fluxo de Trabalho

Este requisito se trata da edição e personalização conforme necessidade das etapas e processos: adicionando, removendo ou reordenando etapas, para adaptar o processo às necessidades específicas.
    
→ [Voltar ao topo](#topo)


### Planejamento de entregas
![image](https://github.com/m-u-l-a-s/PROTON/blob/main/docs/sprint2.png)
...
![Burndown Chart](https://github.com/m-u-l-a-s/PROTON/blob/main/docs/burndownSprint02.png)
</div>
